...
* [2014-06-11 Wed] Changing the host name on Ubuntu         :@network:@linux:
  : $ sudo vi /etc/hostname
  : $ sudo service hostname start

* [2014-06-14 Sat] Rsync command                                     :@rsync:
  : rsync -av --progress --inplace --exclude '.AppleDouble' --exclude '.DS_Store' --remove-source-files 

* [2014-06-14 Sat] Mux / Demux mp4 with MP4Box                 :@mp4:@mp4box:
  - Info (list tracks)
    : MP4Box -list <input_file>
  - Demux
    : MP4Box -single <track_number> <input_file>
  - Mux
    : MP4Box -add <track> -add <track> <output_file>
